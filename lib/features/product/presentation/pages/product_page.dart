                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          else if (provider.errorMessage != null && product == null)
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(product.title ?? 'Product', style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600)),
        const SizedBox(height: 12),
        Text(
          product.description ?? '',
        ...
        Wrap(
          ...
          runSpacing: 8,
          children: [
            _InfoChip(label: 'Rating: ${(product.rating ?? 0).toStringAsFixed(1)}'),
            _InfoChip(label: 'Stock: ${product.stock ?? 0}'),
            _InfoChip(label: 'Brand: ${product.brand ?? '-'}'),
            _InfoChip(label: 'Category: ${product.category ?? '-'}'),
          ],
        ),
        if (product.tags != null && product.tags!.isNotEmpty) ...[
          ...
          Wrap(spacing: 8, runSpacing: 8, children: product.tags!.map((tag) => Chip(label: Text(tag))).toList()),
        ],
      ],
    );
  }
