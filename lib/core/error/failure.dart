...
final class StorageFailure extends Failure {
  const StorageFailure({required super.message}) : super(statusCode: 500);
}

final class JwtDecodeFailure extends Failure {
  const JwtDecodeFailure({required super.message}) : super(statusCode: 401);
}
...
final class DataParsingFailure extends Failure {
  const DataParsingFailure({required super.message}) : super(statusCode: 422);
}

final class LocationFailure extends Failure {
  const LocationFailure({required super.message}) : super(statusCode: 503);
}
...
final class NavigationFailure extends Failure {
  const NavigationFailure({required super.message}) : super(statusCode: 500);
}
